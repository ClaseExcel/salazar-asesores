            ...
            <div class="p-4 bg-white border rounded-lg shadow-md">
                <div class="container mb-4">
                    <div>
                        ...
                        style="text-shadow: 1px 1px 1px  rgba(49, 49, 49, 0.323);">{{ __('Editar actividad') }}
                        <p>
                    </div>
                </div>

                <form method="POST" action="{{ route('admin.actividad_cliente.update', $actividad_cliente->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid gap-4 col-span-2 sm:grid-cols-3 sm:gap-6">
                                ...
                                <select name="actividad_id" id="actividad_id" onchange="view_periodicidad()" 
                                    ...
                                    @if (!is_null($actividad))
                                        @foreach ($actividad as $id => $nombre)
                                            <option
                                                {{ $actividad_cliente->actividad_id == $id ? 'selected' : '' }} 
                                                value="{{ $id }}">{{ $nombre }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="relative">
                                <select name="progreso" id="progreso" 
                                    ...
                                    @for ($i = 0; $i <= 100; $i++)
                                        <option 
                                            {{ $actividad_cliente->progreso == $i ? 'selected' : '' }} 
                                            value="{{ $i }}">{{ $i }}
                                        </option>
                                    @endfor
                                </select>
                            ...
                            <div class="relative">
                                <select name="prioridad" id="prioridad" 
                                    ...
                                    <option value="SI" {{ $actividad_cliente->prioridad == 'SI' ? 'selected' : '' }}>SI</option>
                                    <option value="NO" {{ $actividad_cliente->prioridad == 'NO' ? 'selected' : '' }}>NO</option>
                                </select>
                                <label for="prioridad"
                                    class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">
                            ...
                            <div class="relative">
                                <input type="date" id="fecha_vencimiento" name="fecha_vencimiento"
                                    value="{{ $actividad_cliente->fecha_vencimiento }}"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=""/>
                            ...
                            <div class="relative" id="div_periodicidad">
                                <input type="number" id="periodicidad" name="periodicidad"
                                    value="{{ $actividad_cliente->periodicidad }}"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=""/>
                            ...
                            {{-- <div class="relative" id="div_periodicidad_corte">
                                <input type="number" id="periodicidad_corte" name="periodicidad_corte"
                                    value="{{ $actividad_cliente->periodicidad_corte }}"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=""/>
                            ...
                            <div class="relative">
                                <input type="number" id="recordatorio" name="recordatorio"
                                    value="{{ $actividad_cliente->recordatorio }}"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=""/>
                            ...
                            <div class="relative">
                                <input type="number" id="recordatorio_distancia" name="recordatorio_distancia"
                                    value="{{ $actividad_cliente->recordatorio_distancia }}"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=""/>
                            ...
                            <div class="relative">
                                <textarea id="nota" name="nota" rows="1" 
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    >{{ $actividad_cliente->nota }}</textarea>
                                <label for="nota"
                                    class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">
                                    Observación</label>
                            </div>
                            ...
                            <div class="relative">
                                <select name="responsable_id" id="responsable_id" disabled
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                    <option value="">Seleccione un responsable</option>
                                    @if (!is_null($responsable))
                                        @foreach ($responsable as $id => $nombre)
                                            <option
                                                {{ $actividad_cliente->responsable_id == $id ? 'selected' : '' }} 
                                                value="{{ $id }}">{{ $nombre }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="relative">
                                <select name="cliente_id" id="cliente_id" disabled
                                    ...
                                    @if (!is_null($empresa))
                                        @foreach ($empresa as $id => $razon_social)
                                            <option
                                                {{ $actividad_cliente->cliente_id == $id ? 'selected' : '' }} 
                                ...
                                <select name="usuario_id" id="usuario_id" disabled
                                    ...
                                    @if (!is_null($usuario))
                                        @foreach ($usuario as $item)
                                            <option
                                                {{ $actividad_cliente->usuario_id == $item->id ? 'selected' : '' }} 
                                                value="{{ $item->id }}">{{ $item->nombres . ' ' . $item->apellidos }}
                                            </option>
                                        @endforeach
                                    @endif
                                </select>
                            ...
                            @if (count($clientes) > 0)
                            <div class="relative" id='empresa_asociada'> 
                                <select name="empresa_asociada_id" id="empresa_asociada_id"  disabled
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
