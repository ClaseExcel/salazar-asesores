<x-app-layout>
    ...
    <x-jet-bar-container>
        ...
        <div class="flex justify-end mb-4">
            <button onclick="location.href='{{ route('admin.requerimientos.empleado.show', Auth::user()->id) }}'"
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="p-4 bg-white border rounded-lg shadow-md">
                ...
                <form method="POST" action="{{ route('admin.requerimientos.empleado.update-seguimiento', $requerimiento->id) }}" id="edit-requerimiento">
                    @csrf
                    @method('PUT')

                    @include('admin.requerimiento-empleado.fields-seguimiento')
